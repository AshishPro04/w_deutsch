            ...
            WDeutschTheme {
                ...
                Scaffold(
                    ...
                    bottomBar = {
                        WDeutschBottomBar(
                            onHomeClicked = {
                                navController.navigate(WDeutschScreen.HOME.name)
                            },
                            onInfoClicked = {
                                navController.navigate(WDeutschScreen.PRIVACY_POLICY.name)
                            }
                        )
                    }
                ) { innerPadding ->
                    NavHost(
                        ...
                        composable(WDeutschScreen.HOME.name) {
                            HomeScreen() {
                                navController.navigate(WDeutschScreen.GAME.name)
                            }
                        }
                        composable(WDeutschScreen.GAME.name) {
                            ArticleScreen()
                        }
